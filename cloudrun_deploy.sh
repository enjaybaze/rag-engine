...
REGION="us-central1" # e.g., us-central1, europe-west1, etc. The region for Cloud Run service.
VERTEX_AI_LOCATION="us-central1" # The region for Vertex AI services. Often same as REGION.
...
ENV_VARS+=",PYTHONUNBUFFERED=True" # Recommended for Python logging
ENV_VARS+=",RAG_CORPUS_DISPLAY_NAME=${APP_NAME}-corpus" # Example: Use app name for corpus name

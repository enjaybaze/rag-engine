...
echo "  export GCS_BUCKET_NAME=\"your-unique-gcs-bucket-name\""
echo "  export GCS_DESTINATION_FOLDER=\"rag_uploads/\"  # Or your preferred folder in the bucket"
echo "  export FLASK_SECRET_KEY=\"your-very-secret-and-unique-key\" # Recommended for any persistent local use"
echo ""
